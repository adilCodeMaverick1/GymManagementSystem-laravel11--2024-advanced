<x-app-layout>
    <div class="container mx-auto px-4 py-8">
        ...
        <form action="{{ route('members.store') }}" method="POST" class="w-full max-w-lg">
            @csrf
            <div class="mb-4 flex">
            ...
            <div class="mb-4 flex">
                ...
                <div class="w-1/2 ml-2">
                    ...
                    <input type="date" id="join_date" name="join_date" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    @error('join_date')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="flex items-center justify-between">
                <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Add Member</button>
